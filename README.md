...
field does not exist yet, Yamly creates it as an empty array first.
...
instead of replacing it. If the field does not exist yet, Yamly creates it as an
empty object first.
...
is an array, Yamly finds all elements that partially match the non-suffixed
...
exists in the base. If the field is missing, Yamly skips the operation.
